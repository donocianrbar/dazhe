...
- (id)initWithFrame:(CGRect)frame delegate:(id<SGFocusImageFrameDelegate>)delegate focusImageItems:(NSMutableArray *)items
{
    ...
    */
    ...
    for (int i = 0; i < imageItems.count; i++) {
       ...
       // [imageView setBackgroundImage:item.image forState:UIControlStateNormal];
        [imageView sd_setBackgroundImageWithURL:[NSURL URLWithString:item.imageUrl] forState:UIControlStateNormal];
        imageView.tag = i;
        //添加点击事件
